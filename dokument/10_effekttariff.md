...
* Nu har elnätsbolagen infört en ny avgift som kallas Effekttariff.

* Det betyder att du nu betalar för två saker: Volymen (hur mycket el du totalt använder på en månad i kWh) och Hastigheten/Toppen (hur mycket el du använder exakt samtidigt under din mest intensiva timme i kW).
...
* Tänk dig att det svenska elnätet är en stor motorväg, och varje maskin du slår på i huset (ugn, elbilsladdare, tvättmaskin) är en bil du skickar ut på motorvägen.

* **Det gamla sättet:** Du betalade bara för hur många bilar du skickade iväg totalt under en månad, oavsett när de körde.

* **Problemet:** Nästan alla kommer hem klockan 17:00, lagar mat, startar tvättmaskinen och pluggar in elbilen. Plötsligt skickar alla ut sina bilar exakt samtidigt, vilket skapar en enorm trafikstockning.
...
* Lösningen på bilden stavas 'Peak Shaving', vilket handlar om att kapa effekttopparna genom att sprida ut sin förbrukning.

* I det dåliga scenariot slår man på tunga laster samtidigt och skapar en massiv effekttopp på över 16 000 Watt (16 kW).

* I det smarta scenariot används lika mycket el totalt (samma kWh), men effekttoppen blir aldrig högre än 2500 Watt (2,5 kW).
...
* När man betalar för effekttoppar vill man undvika maskiner som drar extremt mycket ström under korta stunder.

* Man vill ha maskiner som "sipprar" el jämnt och lugnt dygnet runt.

* Healthbox 3.0 är det ultimata exemplet på en "snäll" maskin för elnätet.

* Den drar max 85 Watt, vilket motsvarar en enda liten moped på motorvägen.
